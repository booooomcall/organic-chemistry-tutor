...
# ------------------------ AI Naming Assistant ------------------------
    ...
    openai.api_key = st.secrets["openai_api_key"] if "openai_api_key" in st.secrets else "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"

    user_input = st.text_input("Enter a compound formula or description (e.g., CH3CH2OH, a 3-carbon alcohol):")

    if user_input and openai.api_key != "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":
